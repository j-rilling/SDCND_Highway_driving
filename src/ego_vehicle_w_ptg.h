...
class ego_vehicle {
  ...
  private:
    ...
    const double WEIGHT_AVG_LANE_SPEED = 3000.0;
    const double WEIGHT_NEXT_CAR_ON_LANE_SPEED = 500.0;
    const double WEIGHT_NEXT_CAR_ON_LANE_DIST = 800.0;
    const double WEIGHT_DIST_FASTEST_LANE = 1500.0;
    const double WEIGHT_LANE_CHANGE_WHEN_SLOW = 5000.0;
    const double WEIGHT_LANE_CHANGE_NORMAL = 400.0;
    const double WEIGHT_LANE_CHANGE_WHEN_CLOSE_NEXT_CAR = 0.0;
